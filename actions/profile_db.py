...
class User(Base):
    ...
    id_num = Column(String(255), unique=True)
...
class Plan(Base):
    ...
    pay_method = Column(String(255), nullable=False)
...
class ProfileDB:
    ...
    def create_tables(self):
        ...
        Plan.__table__.create(self.engine, checkfirst=True)
        SIM.__table__.create(self.engine, checkfirst=True)
